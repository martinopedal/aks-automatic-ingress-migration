...
1. Create the AGC managed identity and configure Workload Identity federation per `docs/runbook/03-identity-wiring.md`. The IaC modules in this sample provision the AGC dataplane but do not create the identity. Identity wiring is covered in runbook phase 03.
